    ...
    <div class="slider-wrap">
        <div id="slider_1" class="owl-carousel" data-nav="true" data-dots="false" data-autoplay="true"
            ...
            @foreach($sliders as $key => $slider)
                <div class="slider_item_container" data-bg_img="{{ storage_path() }}/images/{{$slider->type}}/{{$slider->photo}}" data-bg_color="#555555"
                     data-bg_opacity="0.0">
                    <div class="item">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="testimony-layout-1">
                                ...
                                <p class="testimony-text">
                                    ...
                                    I
                                    always want to give to the human race. I love to help others! Moreover it gives a
                                    real
                                    peace in my mind.
                                </p>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="event-layout-1 theme-custom-box-shadow clearfix">
                                    ...
                                    <div class="event-info">
                                        <a class="event-date" href="#"><i class="fa fa-calendar-o"></i> 24 February,
                                            2018</a>
                                        <h4>
                                            <a href="#">Opening Donation Day</a>
                                        </h4>
                                        <div class="event-exceprt">Lorem ipsum dolor sit amet turadipi scing elit lobort
                                            issim consecte lodign pharetra. Lobort qssim tronsecte diagnosis sharetrx
                                            mauris
                                            gone do.
                                        </div>
